...
#define OMAP4430_VDD_MPU_OPPBOOST_UV            1350000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPBOOST, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
#define OMAP4430_VDD_IVA_OPPBOOST_UV              1257000
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPTURBO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPBOOST_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 800000000, OMAP4430_VDD_MPU_OPPTURBO_UV),
        /* MPU OPP4 - OPP-SB */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPBOOST_UV),
	/* MPU OPP4 - OPP-SB */
...
#define OMAP4460_VDD_MPU_OPPBOOST_UV            1250000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPBOOST_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPBOOST, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
#define OMAP4460_VDD_IVA_OPPBOOST_UV            1325000
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPTURBO_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPBOOST_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPBOOST, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPTURBO_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4460_VDD_MPU_OPPBOOST_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 920000000, OMAP4460_VDD_MPU_OPPTURBO_UV),
        /* MPU OPP4 - OPP-Nitro */
        OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1200000000, OMAP4460_VDD_MPU_OPPBOOST_UV),
	/* MPU OPP4 - OPP-Nitro */
	...
	/* IVA OPP4 - OPP-Nitro */
	OPP_INITIALIZER("iva", "dpll_iva_m5x2_ck", "iva", false, 430000000, OMAP4460_VDD_IVA_OPPBOOST_UV),
