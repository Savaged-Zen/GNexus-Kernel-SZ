...
#define OMAP4430_VDD_MPU_OPPOC2_UV              1400000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPOC1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPOC2_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPOC2, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPOC1_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4430_VDD_MPU_OPPOC2_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
        ...
        /* MPU OPP4 - OPP-SB */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPOC2_UV),
	/* L3 OPP1 - OPP50 */
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOC2_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
...
#define OMAP4460_VDD_IVA_OPPOC2_UV              1450000
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPOC1, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPOC2_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPOC2, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
